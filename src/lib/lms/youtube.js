...
// own hardened container (see components/lms/YouTubePlayer.js) which blocks the
// right-click menu and renders its own playback controls, so YouTube's chrome is
// hidden here. Rationale:
