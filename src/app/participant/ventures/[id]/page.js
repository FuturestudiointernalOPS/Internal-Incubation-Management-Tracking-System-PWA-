...
export default function VentureDetail() {
  ...
  return (
    <DashboardLayout role={user.role || "participant"}>
      <div className="p-6 max-w-3xl mx-auto space-y-6" style={{ color: "var(--text-primary)" }}>
        {/* Back */}
        <button
        ...
        <div className="flex items-center gap-4">
          <div
            ...
            style={{ backgroundColor: form.brandColor || "#f60" }}
          >
        ...
        {/* Tabs */}
        <div className="flex gap-1 border-b" style={{ borderColor: "rgb(255 255 255 / 0.1)" }}>
          <button
            onClick={() => setActiveTab("profile")}
            className="px-4 py-2 text-sm font-medium border-b-2 transition-colors"
            style={{
              borderColor: activeTab === "profile" ? "var(--brand-orange)" : "transparent",
              color: activeTab === "profile" ? "var(--brand-orange)" : "var(--text-secondary)",
            }}
          >
            {t("venture.profile")}
          </button>
          <button
            ...
            className="px-4 py-2 text-sm font-medium border-b-2 transition-colors"
            style={{
              borderColor: activeTab === "settings" ? "var(--brand-orange)" : "transparent",
              color: activeTab === "settings" ? "var(--brand-orange)" : "var(--text-secondary)",
            }}
          >
            {t("venture.settings")}
          </button>
        ...
        <form onSubmit={handleSave} className="space-y-6">
          {activeTab === "profile" ? (
            <div className="rounded-xl p-6 space-y-4 border" style={{ backgroundColor: "rgb(255 255 255 / 0.05)", borderColor: "rgb(255 255 255 / 0.1)" }}>
              <div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <input value={form.brandColor} onChange={(e) => setForm({...form, brandColor: e.target.value})}
                    className="flex-1 px-3 py-2 rounded-lg outline-none border font-mono text-sm" style={inputStyle} placeholder="#f60" />
                </div>
              </div>
            </div>
          )}
