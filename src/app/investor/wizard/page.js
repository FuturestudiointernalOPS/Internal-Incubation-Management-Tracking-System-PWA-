        ...
        <div className="bg-[var(--surface-1)] border border-[var(--border-primary)] rounded-2xl p-6 space-y-4 min-h-[320px]">
          ...
          {step === 0 && (<div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <input type="password" value={confirmPassword} onChange={event => setConfirmPassword(event.target.value)} placeholder={t("wizard.confirm") + " *"} className="px-4 py-3 bg-[var(--surface-2)] border rounded-xl text-sm font-bold text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] outline-none focus:border-brand-orange/60" />
            </div>
          </div>)}
          ...
          {step === 1 && (<div className="space-y-3">
            ...
            <textarea value={biography} onChange={event => setBiography(event.target.value)} rows={3} placeholder={t("wizard.bio")} className="w-full px-4 py-3 bg-[var(--surface-2)] border rounded-xl text-sm font-bold text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] outline-none focus:border-brand-orange/60 resize-none" />
            <div className="grid grid-cols-2 gap-3">
