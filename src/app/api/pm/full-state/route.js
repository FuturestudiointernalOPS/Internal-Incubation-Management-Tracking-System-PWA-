  ...
  try {
    ...
    const queries = [
      ...
      },
      {
        ...
        SELECT CAST(id AS TEXT) as id, user_id, program_id, name, email, phone, screening_status, created_at, 'MANUAL' as group_name, 'manual' as source, v2_team_id FROM v2_participants WHERE program_id = ?
        args: [id],
      },
      {
