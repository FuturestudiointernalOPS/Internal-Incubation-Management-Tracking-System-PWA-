        ...
        <header className="flex flex-col md:flex-row justify-between items-end gap-8">
          <div className="space-y-4">
             <div className="flex items-center gap-3">
                ...
                <div>
                   <h2 className="text-4xl font-black text-white uppercase italic tracking-tighter leading-none">Progress Registry</h2>
                   <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mt-2">Tactical fulfillment auditing across all assigned theaters</p>
                </div>
             </div>
          </div>
        ...
        <div className="grid grid-cols-1 gap-6">
           {filteredPrograms.map((prog, idx) => {
              ...
              return (
                 <motion.div 
                    ...
                    onClick={() => router.push(`/pm/programs/${prog.id}?tab=progress`)}
                 ...
                 >
                    <div className="flex-1 space-y-6 w-full text-left">
                       <div className="flex items-center gap-4">
                          ...
                          <div>
                             ...
                             <p className="text-[10px] font-bold text-slate-600 uppercase tracking-widest mt-2">{prog.sessions_count || 0} Tactical Nodes • {prog.participants_count || 0} Personnel</p>
                          </div>
                       </div>
                       ...
                       <div className="space-y-3">
                          <div className="flex justify-between items-end">
                             <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest italic">Current Velocity</p>
                    ...
                    <div className="flex items-center gap-8 px-12 border-l border-white/5 hidden lg:flex">
                       ...
                       <div className="text-center">
                          ...
                          <p className="text-xs font-black text-[#FF6600] uppercase tracking-tighter italic">Active</p>
                       </div>
                    </div>
           ...
           {isLoaded && filteredPrograms.length === 0 && (
              <div className="ios-card bg-white/[0.01] border-dashed border-white/10 !p-24 flex flex-col items-center justify-center gap-6 opacity-40">
                 ...
                 <p className="text-sm font-black text-slate-800 uppercase tracking-widest italic text-center leading-relaxed">No assigned programs detected in your theater.<br/>Awaiting tactical deployment.</p>
              </div>
           )}
        </div>
      </div>
