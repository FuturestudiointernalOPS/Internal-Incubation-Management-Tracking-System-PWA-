      ...
      <div className="space-y-8 animate-in text-left">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-[var(--border-secondary)] pb-8">
          ...
          <div className="flex items-center gap-4 bg-secondary border border-[var(--border-primary)] p-2 rounded-2xl shadow-sm">
            <button
              onClick={prevMonth}
              className="p-2 hover:bg-tertiary rounded-xl transition-all text-[var(--text-primary)]"
            >
            ...
            <div className="px-4 text-center min-w-[140px]">
              ...
              <p className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-[0.2em] opacity-60">
                {year}
              </p>
            </div>
            <button
              ...
              <div className="space-y-6">
                {sessions.length > 0 ? (
                  sessions.slice(0, 5).map((s) => (
                    <div
                      key={s.id}
                      className="group relative pl-4 border-l-2 border-[var(--brand-orange)]/20 hover:border-[var(--brand-orange)] transition-all py-1"
                    >
                      <p className="text-[10px] font-black text-[var(--brand-orange)] uppercase tracking-widest mb-1">
                        {s.scheduled_date}
                      </p>
