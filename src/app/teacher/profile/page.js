    ...
    try {
      ...
      if (data.success && data.contacts) {
        const found = data.contacts.find(
          (c) => c.cid === user.cid || c.email === user.email,
        );
        if (found) {
          setDbUser(found);
        } else {
      ...
      <div className="min-h-screen bg-[#080810] flex items-center justify-center p-8">
        <div className="ios-card bg-rose-500/5 border-rose-500/20 p-12 text-center max-w-md">
          ...
          <p className="text-slate-500 font-bold text-sm leading-relaxed mb-8">
            We could not synchronize your reviewer credentials with the
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        <header className="border-b border-white/5 pb-10">
          ...
          <p className="text-slate-500 font-bold mt-4 opacity-70">
            Managing your evaluation authority and access credentials.
          </p>
        </header>
          ...
          <div className="md:col-span-2 space-y-8">
            <div className="ios-card bg-[#0d0d18] border-white/5 !p-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                ...
                <div className="space-y-1">
                  <p className="flex items-center gap-2 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-2">
                    <Mail className="w-3 h-3" /> Evaluation Email
                  </p>
            ...
            <div className="ios-card bg-[#FF6600]/80/5 border-[#FF6600]/80/20 !p-12 space-y-8">
              <div>
                ...
                <p className="text-xs text-slate-400 font-bold mt-2 italic">
                  Update your review terminal access key.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-end gap-6">
                ...
                <button
                  onClick={async () => {
                    ...
                    const newName =
                      document.getElementById("teacher_name_field").value;
