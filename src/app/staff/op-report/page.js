            ...
            {reportType === "standup" ? (
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="overflow-hidden rounded-xl border border-[var(--border-primary)]">
                    <table className="w-full">
                      <thead>
                        <tr className="bg-tertiary border-b border-[var(--border-primary)]">
                          <th className="w-12 px-3 py-2.5 text-center text-[9px] font-semibold text-slate-500 uppercase tracking-wider">
                            Done
                          </th>
                          <th className="text-left px-3 py-2.5 text-[9px] font-semibold text-slate-500 uppercase tracking-wider">
                            Task
                          </th>
                          <th className="text-left px-3 py-2.5 text-[9px] font-semibold text-slate-500 uppercase tracking-wider">
                            Project
                          ...
                          <tr>
                            <td colSpan={6} className="px-4 py-8 text-center">
                              ...
                              <p className="text-[9px] text-slate-600 mt-0.5">
                                No outstanding work for this week
                              </p>
                            </td>
                          </tr>
                        ) : (
                          tasks
                            ...
                            .map((task) => {
                              ...
                              return (
                                <tr
                                  key={task.id}
                                  className={`border-b border-[var(--border-primary)]/40 hover:bg-tertiary/30 transition-colors ${isChecked ? "opacity-60" : ""}`}
                                >
                                    ...
                                    <button
                                      onClick={() => {
                                        if (
                                          ...
                                          alert(
                                            "Resolve all blockers before completing this task.",
                                          );
                                          return;
                                        }
                                  ...
                                  <td className="px-3 py-2.5">
                                    <span
                                      className={`text-[11px] font-medium ${isChecked ? "line-through text-slate-500" : "text-[var(--text-primary)]"}`}
                                    >
                                      {task.title}
                                    </span>
                                  </td>
                                  ...
                                  <td className="px-3 py-2.5">
                                    <span
                                      className={`text-[8px] font-semibold px-1.5 py-0.5 rounded-full ${config.bg} ${config.color}`}
                                    >
                                      {config.label}
                                    </span>
                                  </td>
                ...
                <div>
                  ...
                  {tasks.filter((t) => (t.blockers || []).length > 0).length ===
                  0 ? (
                    ...
                    <div className="overflow-hidden rounded-xl border border-[var(--border-primary)]">
                      <table className="w-full">
                        <thead>
                          <tr className="bg-tertiary border-b border-[var(--border-primary)]">
                            <th className="w-12 px-3 py-2 text-center text-[9px] font-semibold text-slate-500 uppercase tracking-wider">
                              Resolved
                            </th>
                            <th className="text-left px-3 py-2 text-[9px] font-semibold text-slate-500 uppercase tracking-wider">
                              Blocker
                          ...
                          {tasks
                            ...
                            .flatMap((task) =>
                              (task.blockers || []).map((blocker) => (
                                <tr
                                  key={blocker.id}
                                  className="border-b border-[var(--border-primary)]/40 hover:bg-tertiary/30 transition-colors"
                                >
                                  <td className="px-3 py-2 text-center">
                                    <button
                                      onClick={() => {
                                        setReconciledBlockers((prev) => ({
                                          ...prev,
                                          [blocker.id]: !prev[blocker.id],
                                        }));
                                      }}
                                      className={`w-4 h-4 rounded border-2 flex items-center justify-center transition-all ${
                                        blocker.status === "resolved" ||
                                        reconciledBlockers[blocker.id]
                                  ...
                                  <td className="px-3 py-2 text-[10px] font-medium text-[var(--text-primary)]">
                                    {blocker.title}
                                  </td>
                      ...
                      <input
                        ...
                        onKeyDown={(e) => {
                          if (e.key === "Enter" && newWin.trim()) {
                            ...
                            setForm((p) => ({
                              ...p,
                              wins: [...p.wins, newWin.trim()],
                            }));
                            setNewWin("");
                          }
                        }}
                        placeholder="Add a key win..."
                        className="flex-1 bg-primary border border-[var(--border-primary)] rounded-lg px-3 py-1.5 text-[10px] font-medium outline-none focus:border-[var(--brand-orange)] transition-all"
                      />
                      <button
                        onClick={() => {
                          if (newWin.trim()) {
                        ...
                        className="px-3 py-1.5 bg-[var(--brand-orange)] text-black rounded-lg text-[9px] font-semibold hover:brightness-110 transition-all"
                      >
                        Add
                      </button>
                    </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={2}
                    placeholder="Any additional thoughts on this week?"
                ...
                <div className="flex justify-end gap-3 pt-2">
                  <button
                    onClick={async () => {
                      ...
                      const completed = Object.entries(reconciledTasks).filter(
                        ([_, v]) => v,
                      );
                      ...
                      notify(
                        "Retro submitted. Uncompleted tasks carried over.",
                        "success",
                      );
                      fetchTasks();
                      setReconciledTasks({});
