...
const KANBAN_COLUMNS = [
  {
    id: "planning",
    label: "adminMisc.work.column.planning",
    icon: Target,
  ...
  {
    id: "pending_approval",
    label: "adminMisc.work.column.pending_approval",
    icon: Clock,
  ...
  {
    id: "in_progress",
    label: "adminMisc.work.column.in_progress",
    icon: ListTodo,
    color: "text-blue-400",
    bg: "bg-blue-500/10",
  },
  {
    id: "blocked",
    label: "adminMisc.work.column.blocked",
    icon: AlertTriangle,
    color: "text-rose-400",
    bg: "bg-rose-500/10",
  },
  {
    id: "completed",
    label: "adminMisc.work.column.completed",
    icon: CheckCircle2,
      ...
      <div className="space-y-6 pb-20">
        ...
        <div className="flex items-center justify-between border-b border-[var(--border-primary)] pb-6">
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder={t("adminMisc.work.searchTasks")}
                value={search}
                  ...
                  return (
                    <div key={program.id} className="space-y-1">
                      ...
                      >
                        ...
                        {program.name ||
                          program.title ||
                          t("adminMisc.work.programFallback", {
                            id: program.id,
                          })}
                      </button>
        ...
        <div className="flex items-center gap-6 text-[9px] text-[var(--text-secondary)] font-medium">
          <span className="flex items-center gap-1.5">
            <FolderOpen className="w-3 h-3 text-indigo-400" />
            {t("adminMisc.work.program")}
          </span>
          <span className="flex items-center gap-1.5">
            <Briefcase className="w-3 h-3 text-emerald-400" />
            {t("adminMisc.work.project")}
          </span>
          <span className="flex items-center gap-1.5">
            <span className="w-2 h-2 rounded-full bg-[var(--brand-orange)]" />
            {t("adminMisc.work.dragBetweenColumns")}
          </span>
        </div>
      </div>
    </DashboardLayout>
