    ...
    <>
      <div className="space-y-8 min-h-[60vh]">
        <header className="flex flex-col lg:flex-row justify-between items-start gap-6">
          <div>
            <h2 className="text-4xl font-black text-white tracking-tighter uppercase mb-2">{t("adminMisc.settings.title")}</h2>
            <p className="text-slate-400 font-bold tracking-tight">{t("adminMisc.settings.subtitle")}</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
           <div className="md:col-span-1 space-y-4">
              <div className="ios-card bg-[#FF6600]/80/5 border-[#FF6600]/80/10 cursor-pointer hover:border-[#FF6600]/80/30 transition-all flex items-center gap-4">
                 ...
                 <div>
                    <h4 className="text-white font-black uppercase text-sm">{t("adminMisc.settings.globalNetwork")}</h4>
              ...
              <div className="ios-card bg-white/5 border-white/5 cursor-pointer hover:bg-white/10 transition-all flex items-center gap-4 opacity-70">
                 ...
                 <div>
                    <h4 className="text-white font-black uppercase text-sm">{t("adminMisc.settings.tursoEdge")}</h4>
              ...
              <div className="ios-card bg-white/5 border-white/5 cursor-pointer hover:bg-white/10 transition-all flex items-center gap-4 opacity-70">
                 ...
                 <div>
                    <h4 className="text-white font-black uppercase text-sm">{t("adminMisc.settings.authProtocols")}</h4>
              ...
              <div>
                 ...
                 <div className="space-y-6">
                    <div className="space-y-2">
                       <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest">{t("adminMisc.settings.baseDeploymentUrl")}</label>
                    ...
                    <div className="space-y-2">
                       <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest">{t("adminMisc.settings.maintenanceMode")}</label>
