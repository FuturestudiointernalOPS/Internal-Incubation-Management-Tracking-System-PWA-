    ...
    try {
      ...
      if (data.success && data.contacts) {
        ...
        const found = data.contacts.find(
          (c) => c.role === "super_admin" || c.email === "admin@impactos.com",
        );
        if (found) {
          setDbUser(found);
        } else {
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        <header className="border-b border-white/5 pb-10">
          ...
          <p className="text-slate-500 font-bold mt-4 opacity-70">
            Manage your administrative identity and account credentials.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-1 space-y-6">
            <div className="ios-card bg-mesh py-16 flex flex-col items-center text-center">
              ...
              <p className="text-[10px] font-black text-[#FF6600] uppercase tracking-widest mt-1">
                Super Admin
              </p>
            </div>
          </div>
            ...
            <div className="ios-card bg-[#FF6600]/80/5 border-[#FF6600]/80/20 !p-12 space-y-8">
              ...
              <div className="flex flex-col sm:flex-row items-end gap-6">
                <div className="flex-1 space-y-2 w-full relative">
                  <label className="text-[10px] font-black text-[#FF6600] uppercase tracking-widest pl-2">
                    New Password
                  </label>
                ...
                <button
                  onClick={async () => {
                    const newPass =
                      document.getElementById("sa_password_field").value;
                    const newName =
                      document.getElementById("sa_name_field").value;
