    ...
    <>
      ...
      {detailMember && (
        <DetailModal
          ...
          fmtDate={fmtDate}
          readOnly={readOnly}
          effectiveAccessHref={effectiveAccessHref}
...
function DetailModal({ member, derived, isProtected, t, fmtDate, readOnly, effectiveAccessHref, onClose, onHistory }) {
  const statusLabel = {
