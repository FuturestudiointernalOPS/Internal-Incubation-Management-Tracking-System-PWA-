    ...
    >
      <div className="space-y-5">
        ...
        <div>
          ...
          {extracted && (
            <div className="mt-3">
              {/* Live preview of the reference typed above, through the shared
                  embed: same poster, same looping player as the course view. */}
              <EmbeddedVideo
                key={extracted}
                videoId={extracted}
                title={t("lms.lessons.playPreview")}
                playLabel={t("lms.lessons.playPreview")}
              />
            </div>
          )}
        </div>
