...
## Summary
- 949 nodes · 1312 edges · 182 communities (127 shown, 55 thin omitted)
...
Cohesion: 0.05
Nodes (31): POST(), POST(), POST(), GET(), GET(), GET(), PATCH(), DELETE() (+23 more)
...
Cohesion: 0.06
Nodes (29): GET(), POST(), PATCH(), GET(), GET(), POST(), GET(), POST() (+21 more)
...
Cohesion: 0.11
Nodes (14): ParticipantDashboard(), StaffDashboard(), ProgramWorkspace(), useI18n(), LoginPage(), AdminOpReports(), formatLabel(), MonthlyBreakdown() (+6 more)
